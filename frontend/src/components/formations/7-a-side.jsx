  ...
  return (
    <div className="container">
      <div className="header-container">
        ...
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/7-a-side/2-2-2.png`} alt="2-2-2" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
            <ul>
              <li>Balanced throughout the whole team</li>
              <li>Is a progression of the 2-2 (box) formation</li>
            </ul>
          </li>
          <li className = "li-style"><strong>Cons:</strong>
            <ul>
          ...
          <li className = "li-style"><strong>Tips:</strong>
            <ul>
      ...
      <div className="header-container">
        ...
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/7-a-side/2-3-1.png`} alt="2-3-1" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
      ...
      <div className="header-container">
        <h2>3-2-1 (Arrow)</h2>
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/7-a-side/3-2-1.png`} alt="3-2-1" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
