  ...
  return (
    <div className="container">
      <div className="header-container">
        ...
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/5-a-side/2-1-1.png`} alt="2-1-1" />
      </div>
      ...
      <div className="header-container">
        <h2>2-2 (Box)</h2>
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/5-a-side/2-2.png`} alt="2-2" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
