  ...
  return (
    <div className="container">
      <div className="header-container">
        ...
        <h2>2-3-3</h2>
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/9-a-side/2-3-3.png`} alt="2-3-3" />
      </div>
      ...
      <div className="header-container">
        <h2>3-2-3</h2>
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/9-a-side/3-2-3.png`} alt="3-2-3" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
      ...
      <div className="header-container">
        <h2>3-3-2</h2>
        <img className = "formation-img" src={`${process.env.PUBLIC_URL}/images/9-a-side/3-3-2.png`} alt="3-3-2" />
      </div>
      <div className="list-container">
        <ul className="list-item">
          <li className = "li-style"><strong>Pros:</strong>
