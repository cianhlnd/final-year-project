...
function U12sDefendingSession() {
  const sessionPlans = [
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/defending/0.png',
      imageName: 'u12s-defending-warm-up.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/defending/1.png',
      imageName: 'u12s-defending-drill-1.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/defending/2.png',
      imageName: 'u12s-defending-drill-2.png',
    },
    {
  ...
  const downloadAllSessionPlans = async () => {
    ...
    zip.generateAsync({ type: 'blob' }).then((content) => {
      saveAs(content, 'u12s-defending-session-plans.zip');
    });
  };

  return (
    <div className="session-container">
      <h1 className="title">U12s Defending</h1>
...
export default U12sDefendingSession;