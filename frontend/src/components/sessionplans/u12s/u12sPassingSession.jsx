...
function U12sPassingSession() {
  const sessionPlans = [
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/passing/0.png',
      imageName: 'u12s-passing-warm-up.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/passing/1.png',
      imageName: 'u12s-passing-drill-1.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u12s/passing/2.png',
      imageName: 'u12s-passing-drill-2.png',
    },
    {
  ...
  return (
    <div className="session-container">
      <h1 className="title">U12s Passing</h1>
...
export default U12sPassingSession;