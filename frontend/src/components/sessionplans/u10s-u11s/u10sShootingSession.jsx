...
function U10sShootingSession() {
  const sessionPlans = [
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/shooting/0.png',
      imageName: 'u10s-u11s-shooting-warm-up.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/shooting/1.png',
      imageName: 'u10s-u11s-shooting-drill-1.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/shooting/2.png',
      imageName: 'u10s-u11s-shooting-drill-2.png',
    },
    {
  ...
  return (
    <div className="session-container">
      <h1 className="title">U10s-U11s Shooting</h1>
...
export default U10sShootingSession;