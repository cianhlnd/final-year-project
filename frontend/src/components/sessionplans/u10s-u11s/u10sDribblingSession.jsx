...
function U10sDefendingSession() {
  const sessionPlans = [
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/dribbling/0.png',
      imageName: 'u10s-u11s-dribbling-warm-up.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/dribbling/1.png',
      imageName: 'u10s-u11s-dribbling-drill-1.png',
    },
    {
      imageUrl: process.env.PUBLIC_URL + '/images/u10s-u11s/dribbling/2.png',
      imageName: 'u10s-u11s-dribbling-drill-2.png',
    },
    {
  ...
  return (
    <div className="session-container">
      <h1 className="title">U10s-U11s Dribbling</h1>
